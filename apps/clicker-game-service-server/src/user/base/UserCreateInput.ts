...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ClickCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => ClickCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => ClickCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => GameSessionCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => GameSessionCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => GameSessionCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
